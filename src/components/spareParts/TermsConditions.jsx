      ...
      <div className="lg-container">
        ...
        <div className="card-body">
          ...
          <p
            ...
            style={{ fontSize: ".6rem", textAlign: "justify" }}
          >
          ...
          <h3 style={{ fontSize: ".8rem" }}>Appointment scheduling </h3>
          ...
          <h3 style={{ fontSize: ".8rem" }}>Payment Terms</h3>
          ...
          <h3 style={{ fontSize: ".8rem" }}>Liability</h3>
          ...
          <h3 style={{ fontSize: ".8rem" }}>Genuine parts. </h3>
          ...
          <h3 style={{ fontSize: ".8rem" }}>Service Areas </h3>
          ...
          <h3 style={{ fontSize: ".8rem" }}>Customer's Responsibility </h3>
